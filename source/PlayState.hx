...
var creditText:FlxText = new FlxText(876, 648, 348);
		...
		creditText.setFormat(Paths.font("Milky Nice.ttf"), 30, FlxColor.BLUE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		...
		timeBar.createFilledBar(0xFF000000, 0xFFDCEEFF);
